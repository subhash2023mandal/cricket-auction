...
const BID_REACTIONS_CLASSIC = [
  ...
  { minLakh: 1300, text: 'Yeh cricket hai ya IPO? 📈' },
  { minLakh: 1500, text: 'Volt se loan le ke khel rahe ho? 💳🤔' },
  { minLakh: 1700, text: 'Yeh toh Virat se bhi mehnga ho gaya 🏏👑' },
  { minLakh: 1900, text: 'RBI ko bula lo 🏦' },
